...
if __name__ == "__main__":
    ...
    LinkedList_Parser = argparse.ArgumentParser()
    ...
    LinkedList_Parser.add_argument("--insert_value", help='insert this value to defined index by --insert_index', default = None, type = str)
    ...
    args = LinkedList_Parser.parse_args()
