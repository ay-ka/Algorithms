...
if __name__ == "__main__":
    ...
    UCS_Parser = argparse.ArgumentParser()
    
    #bfs
    
    UCS_Parser.add_argument("--start", default="1", help='start node', type = str)
        
    UCS_Parser.add_argument("--goal", default="2",  help='goal node', type = str)
