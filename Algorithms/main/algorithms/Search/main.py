...
if __name__ == "__main__":
    ...
    Binary.add_argument("--data", default= [3, 9, 10, 27, 38, 43, 82],  nargs = "+", help='data to sort (list)', type = int)
    
    Binary.add_argument("--value", default= 9,  help='value to search', type = int)
    
    # fibo
    
    Fibo.add_argument("--data", default= [3, 5, 15, 26, 27, 44,  46, 47,  50],  nargs = "+", help='data to sort (list)', type = int)
