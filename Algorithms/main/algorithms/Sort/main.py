...
if __name__ == "__main__":
    ...
    Merge.add_argument("--data", default= [3, 44, 38, 5, 47, 15, 36, 26, 27, 2, 46, 4, 4, 19, 50, 48],  nargs = "+", help='data to sort (list)', type = int)
    
    # quick
    
    Quick.add_argument("--data", default= [3, 44, 38, 5, 47, 15, 36, 26, 27, 2, 46, 4, 4, 19, 50, 48],  nargs = "+", help='data to sort (list)', type = int)
        
    #heap
        
    Heap_.add_argument("--data", default= [3, 44, 38, 5, 47, 15, 36, 26, 27, 2, 46, 4, 4, 19, 50, 48],  nargs = "+",  help='data to sort (list)', type = int)
